...
window.onload=function(){
    ...
    const fondo=new Image(); fondo.src='assets/plantilla.png'; // Creo un objeto Image con el fondo
    ...
    let direccion='izquierda'; // Variable que define hacia donde está mirando o hacia donde miró por última vez
    ...
    //Método que dibuja al protagonista

    Personaje.prototype.dibujarProtagonista=function(){
        ctx.drawImage(
    ...
    function generarPersonaje(){
        ...
        if(xIzquierda) protagonista.moverIzda(); // En caso de estar pulsando la tecla izquierda ejecutará la funcion correspondiente
        if(xDerecha) protagonista.moverDerecha();   // Lo mismo con la izda
        ...
        protagonista.dibujarProtagonista();
    ...
    setInterval(generarPersonaje, animaciones, 300/24); // Intervalos que ejecutará la función que genera el personaje y los sprites
