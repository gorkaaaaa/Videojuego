...
// Todos los elementos tienen como color negro con opacidad 0 (el último 0 de rgba) ya que los sprites estarán
// en el fondo del documento
export let plataformasArray=[
    ...
    {fillStyle: 'rgba(0, 0, 0, 0)', coord:[0,20,120,60]} //------> Helicoptero     
    ];
