...
window.onload=function(){
    ...
    function generarPersonaje(){
        ...
        if(xIzquierda) protagonista.andarIzquierda(); // En caso de estar pulsando la tecla izquierda ejecutará la funcion correspondiente
        if(xDerecha) protagonista.andarDerecha();   // Lo mismo con la izda
